...
public class MicroserviceAControllerTest {

    @InjectMocks
    MicroserviceAController microserviceAController;
    ...
    public void testHealth() {
        ...
        ResponseEntity<HealthResponse> responseEntity = microserviceAController.health();
